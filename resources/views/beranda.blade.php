            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 text-center mx-auto">
                        <h1 class="text-white pt-3 mt-n5">Web-Geolocation</h1>
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="my-4 text-sm">
                            ...
                            </script>UI Design System by <a href="https://www.creative-tim.com" target="_blank">Ramson</a>.
                        </p>
                    </div>
                </div>
            </div>
